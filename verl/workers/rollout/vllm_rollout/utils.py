...
class vLLMColocateWorkerExtension:
    ...
    def _get_zmq_handle(self) -> str:
        ...
        namespace = os.environ.get("VERL_WEIGHT_TRANSFER_NAMESPACE", "rollout")
        return f"ipc:///tmp/rl-colocate-zmq-{job_id}-{namespace}-replica-{replica_rank}-rank-{self.local_rank}.sock"
