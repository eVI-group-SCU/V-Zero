...
# ---- user-adjustable ----
MODEL_ROOT=${MODEL_ROOT:-/home/deeplearn/dataDisk}
STUDENT_MODEL=${STUDENT_MODEL:-${MODEL_ROOT}/qwen3-vl-4b}
...
if [[ "${teacher_ema_enabled}" == "True" || "${teacher_ema_enabled}" == "true" || "${teacher_ema_enabled}" == "1" ]]; then
    ...
    TEACHER_MODEL=${TEACHER_MODEL:-${MODEL_ROOT}/qwen3-vl-32b}
fi
...
run_tag=${RUN_TAG:-reannotate_train23k_qwen3_vl_4b_student_32b_hard_relative}
...
filtered_train_file=${FILTERED_TRAIN_FILE:-/home/deeplearn/dataDisk/zwz_dataset/reannotate_verl_format_teacher_crop_train23k/train.parquet}
...
ACTOR=(
    ...
    actor_rollout_ref.actor.checkpoint.load_contents='["model","optimizer"]'
)
