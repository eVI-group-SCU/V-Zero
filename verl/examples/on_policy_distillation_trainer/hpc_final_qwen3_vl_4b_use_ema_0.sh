...
teacher_ema_decay=${TEACHER_EMA_DECAY:-0}
...
rollout_data_dir=${ROLLOUT_DATA_DIR:-./final_logs_ema_0/rollouts}
validation_data_dir=${VALIDATION_DATA_DIR:-./final_logs_ema_0/val_generations}
