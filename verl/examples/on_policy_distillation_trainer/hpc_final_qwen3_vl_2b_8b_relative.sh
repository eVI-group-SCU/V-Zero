...
# ---- user-adjustable ----
MODEL_ROOT=${MODEL_ROOT:-/home/deeplearn/myhome}
STUDENT_MODEL=${STUDENT_MODEL:-${MODEL_ROOT}/qwen3-vl-2b}
...
if [[ "${teacher_ema_enabled}" == "True" || "${teacher_ema_enabled}" == "true" || "${teacher_ema_enabled}" == "1" ]]; then
    ...
    TEACHER_MODEL=${TEACHER_MODEL:-${MODEL_ROOT}/qwen3-vl-8b}
fi
...
run_tag=${RUN_TAG:-qwen3_vl_2b_student_8b_relative}
...
EXTRA=(
    ...
    distillation.evidence_weighting.negative_mode=downsample_teacher_crop
