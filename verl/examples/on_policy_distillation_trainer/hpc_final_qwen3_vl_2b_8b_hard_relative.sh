...
run_tag=${RUN_TAG:-qwen3_vl_2b_student_8b_hard_relative}
...
filtered_train_file=${FILTERED_TRAIN_FILE:-/home/deeplearn/dataDisk/zwz_dataset/verl_format_teacher_crop_train37k_filtered_maxprompt25000_teachermax32768_hardneg/train.parquet}
