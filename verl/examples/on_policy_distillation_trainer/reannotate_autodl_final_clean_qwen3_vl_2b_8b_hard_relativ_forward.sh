...
run_tag=${RUN_TAG:-autodl_reannotate_qwen3_vl_2b_student_8b_hard_relative}
...
filtered_train_file=${FILTERED_TRAIN_FILE:-/root/autodl-tmp/dataset/ZwZ-RL-VQA/reannotate_verl_format_teacher_crop_train23k_filtered_maxprompt25000_teachermax32768/train.parquet}
