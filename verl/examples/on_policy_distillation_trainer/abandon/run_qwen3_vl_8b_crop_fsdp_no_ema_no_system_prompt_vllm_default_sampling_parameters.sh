...
teacher_ema_decay=${TEACHER_EMA_DECAY:-0.9}
...
rollout_data_dir=${ROLLOUT_DATA_DIR:-./logs_no_ema_no_systemp_prompt_default_temperature/rollouts}
validation_data_dir=${VALIDATION_DATA_DIR:-./logs_no_ema_no_systemp_prompt_default_temperature/val_generations}
