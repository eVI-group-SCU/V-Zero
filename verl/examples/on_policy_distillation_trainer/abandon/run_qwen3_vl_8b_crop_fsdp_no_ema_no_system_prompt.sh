...
rollout_data_dir=${ROLLOUT_DATA_DIR:-./logs_no_ema_no_systemp_prompt/rollouts}
validation_data_dir=${VALIDATION_DATA_DIR:-./logs_no_ema_no_systemp_prompt/val_generations}
