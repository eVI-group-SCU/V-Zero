...
# ---- user-adjustable ----
MODEL_ROOT=${MODEL_ROOT:-/home/deeplearn/myhome/qwen3-vl}
STUDENT_MODEL=${STUDENT_MODEL:-/home/deeplearn/myhome/qwen3-vl}
teacher_ema_enabled=${TEACHER_EMA_ENABLED:-False}
if [[ "${teacher_ema_enabled}" == "True" || "${teacher_ema_enabled}" == "true" || "${teacher_ema_enabled}" == "1" ]]; then
    TEACHER_MODEL=${TEACHER_MODEL:-$STUDENT_MODEL}
else
    TEACHER_MODEL=${TEACHER_MODEL:-/home/deeplearn/myhome/qwen3-vl}
fi
...
rollout_data_dir=${ROLLOUT_DATA_DIR:-./final_logs_no_ema/rollouts}
validation_data_dir=${VALIDATION_DATA_DIR:-./final_logs_no_ema/val_generations}
...
filtered_train_file=${FILTERED_TRAIN_FILE:-/home/deeplearn/dataDisk/zwz_dataset/verl_format_teacher_crop_train37k_filtered_maxprompt25000_teachermax32768/train.parquet}
train_file=${TRAIN_FILE:-${filtered_train_file}}
val_file=${VAL_FILE:-/home/deeplearn/dataDisk/zwz_dataset/validation_450/vstar_hrbench_mme_realworld_val450.parquet}
