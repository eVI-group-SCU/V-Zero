...
class vLLMHttpServer:
    ...
    def __init__(
        ...
        weight_transfer_namespace: str = "rollout",
    ):
        """
        Args:
        ...
        os.environ["VERL_WEIGHT_TRANSFER_NAMESPACE"] = weight_transfer_namespace
...
class vLLMReplica(RolloutReplica):
    ...
    def _weight_transfer_namespace(self) -> str:
        role = self._server_role()
        suffix = self.name_suffix.strip("_")
    ...
    def get_ray_class_with_init_args(self):
        """Get rollout worker actor class with a vLLM weight-transfer namespace."""
        ...
        return RayClassWithInitArgs(
            ...
            weight_transfer_namespace=self._weight_transfer_namespace(),
